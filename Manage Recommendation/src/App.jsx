        ...
        const fetchManga = async () => {
            try {
                const response = await fetch(
                    `${baseUrl}/manga?limit=100&includes[]=cover_art`
                );
                ...
                const topResponse = await fetch(
                    `${baseUrl}/manga?limit=100&order[rating]=desc&includes[]=cover_art`
                );
                ...
                const newResponse = await fetch(
                    `${baseUrl}/manga?limit=100&order[createdAt]=desc&includes[]=cover_art`
                );
        ...
        <Router>
            <div className="bg-black pb-10">
                ...
                <Routes>
                    ...
                    <Route
                        path="/search-by-emotion"
                        element={<SearchByEmotion />}
                    />
                    <Route
                        path="/manga/:title"
                        element={<MangaDetail user={user} />}
                    />
